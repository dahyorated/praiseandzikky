...
//
// Pinned to the canonical www host on purpose. The apex 308s to www, and not
// every email client follows a redirect when fetching an image.
const CELEBRATION_GIF = 'https://www.praizandzikky.info/thankyou.gif';
        ...
        <tr><td style="padding:0 32px 4px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="border-top:1px solid #EADFC8;padding-top:22px;text-align:center;font-family:Helvetica,Arial,sans-serif;">
              ...
              <a href="${GIFTS_LINK}" style="color:${GOLD};font-weight:700;text-decoration:underline;font-size:15px;">See the gift details</a>
            </td></tr>
          </table>
        </td></tr>
